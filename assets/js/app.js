...
const imgenLogo = document.createElement('img');
const origen = document.createElement('a');

origen.href = '/';
origen.appendChild(imgenLogo);
imgenLogo.src = '/assets/img/logo.png';
imgenLogo.alt = 'CoderHouse';
imgenLogo.setAttribute('data-aos', 'zoom-in');
imgenLogo.setAttribute('data-aos-duration', '800')
...
toggleDarkMode.addEventListener('click', () => {
    // alert("Se cambio el modo de pantalla")
    Swal.fire({
        title: "Bien ahi Capo!!",
